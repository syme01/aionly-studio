// 配置信息
const config = {
  R2_CUSTOM_DOMAIN: 'aionly.ocool.online',
  R2_BUCKET_NAME: 'aionly',
  // 缓存键名
  CACHE_KEY: 'aionly-latest-release',
...
async function checkNewRelease(env) {
  try {
    // 获取 GitHub 最新版本
    const githubResponse = await fetch('https://api.github.com/repos/kangfenmao/aionly/releases/latest', {
