...
Automate the AiOnly release workflow: collect changes → generate bilingual release notes → update files → create release branch + PR → trigger CI/CD.
...
```
<!--LANG:en-->
AiOnly {version} - {Brief English Title}
