...
CodeBlockView is the core component in AiOnly for displaying and manipulating code blocks. It supports multiple view modes and visual previews for special languages, providing rich interactive tools.
