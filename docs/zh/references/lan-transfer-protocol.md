...
本文档定义了 AiOnly 桌面客户端（Electron）与移动端（Expo）之间的局域网文件传输协议。
...
// 服务发现
export const LAN_TRANSFER_SERVICE_TYPE = "aionly";
export const LAN_TRANSFER_SERVICE_FULL_NAME = "_aionly._tcp";
