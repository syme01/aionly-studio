...
export type PaintingProvider = 'zhipu' | 'aihubmix' | 'silicon' | 'dmxapi' | 'new-api' | 'ovms' | 'market' | 'ppio'
...
export const BuiltinMCPServerNames = {
  flomo: '@aionly/flomo',
  mcpAutoInstall: '@aionly/mcp-auto-install',
  memory: '@aionly/memory',
  sequentialThinking: '@aionly/sequentialthinking',
  braveSearch: '@aionly/brave-search',
  fetch: '@aionly/fetch',
  filesystem: '@aionly/filesystem',
  difyKnowledge: '@aionly/dify-knowledge',
  python: '@aionly/python',
  didiMCP: '@aionly/didi-mcp',
  browser: '@aionly/browser',
  nowledgeMem: '@aionly/nowledge-mem',
  hub: '@aionly/hub'
} as const
