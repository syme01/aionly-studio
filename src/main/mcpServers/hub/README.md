...
A built-in MCP server that aggregates all active MCP servers in AiOnly and exposes them through **meta-tools**.

This server is the core component of AiOnly’s **Auto MCP Mode**.
