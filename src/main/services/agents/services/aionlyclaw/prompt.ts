...
export class PromptBuilder {
  ...
  async buildSystemPrompt(workspacePath: string, config?: ClawConfiguration): Promise<string> {
    const parts: string[] = []
...
${content}
   ...
   */
  private async shouldRunBootstrap(workspacePath: string, config?: ClawConfiguration): Promise<boolean> {
