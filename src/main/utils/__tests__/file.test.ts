...
describe('file', () => {
  ...
  describe('getTempDir', () => {
    it('should return correct temp directory path', () => {
      ...
      expect(tempDir).toBe('/mock/temp/AiOnly')
    })
  })
  ...
  describe('getConfigDir', () => {
    it('should return correct config directory path', () => {
      ...
      expect(configDir).toBe('/mock/home/.aionlystudio/config')
    })
  })
  ...
  describe('getAppConfigDir', () => {
    it('should return correct app config directory path', () => {
      ...
      expect(appConfigDir).toBe('/mock/home/.aionlystudio/config/test-app')
    })

    it('should handle empty app name', () => {
      const appConfigDir = getAppConfigDir('')
      expect(appConfigDir).toBe('/mock/home/.aionlystudio/config/')
    })
  })
